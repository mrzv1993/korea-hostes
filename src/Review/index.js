        ...
        <div className="row">
          ...
          <div className="col-xs-12">
            ...
            <Answer>
              ...
              сказать, что мне в&nbsp;работе что-то не нравилось. Был, конечно,
              дискомфорт в&nbsp;общении с&nbsp;гостями, но спасало&nbsp;то, что
              всегда можно было увлечь гостя песнями и&nbsp;танцами, играми.
              В&nbsp;общем, в&nbsp;любой ситуации можно было найти выход,
              главное мозги включать 😂 Девочки разные попадаются тоже,
              с&nbsp;которыми живёшь и&nbsp;работаешь, но&nbsp;в&nbsp;целом
          ...
          <div className="col-xs-12">
            ...
            <Answer>
              ...
              будьте разумнее: 21&nbsp;век на&nbsp;дворе, рабство давно
              отменили😂🙈 Я поняла, что для первого контракта лучше выбрать
          ...
          <div className="col-xs-12">
            ...
            <Answer>
              ...
              поглотила, я сделала визу и&nbsp;осталась, живу уже пол года рядом
              с&nbsp;Сеулом. Сейчас, правда, я&nbsp;не&nbsp;работаю
